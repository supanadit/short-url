...
module.exports = function (grunt) {
  ...
  Object.keys(configBridge.paths).forEach(function (key) {
    configBridge.paths[key].forEach(function (val, i, arr) {
      arr[i] = path.join('./docs/vector', val);
    });
  });
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['docs/vector/js/src/*.js', 'docs/vector/js/*.js', '!docs/vector/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'docs/vector/js/customize.min.js'
      },
      docs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/vector/js/docs.min.js'
      }
    },
    ...
    less: {
      ...
      docs: {
        options: {
          ...
          sourceMapFilename: 'docs/vector/css/docs.css.map'
        },
        src: 'docs/vector/less/docs.less',
        dest: 'docs/vector/css/docs.css'
      },
      docsIe: {
        options: {
          sourceMap: false
        },
        src: 'docs/vector/less/ie10-viewport-bug-workaround.less',
        dest: 'docs/vector/css/ie10-viewport-bug-workaround.css'
      }
    },
    ...
    cssmin: {
      ...
      docs: {
        src: 'docs/vector/css/docs.css',
        dest: 'docs/vector/css/docs.min.css'
      }
    },
  ...
  grunt.registerTask('lint-docs-js', ['jshint:vector', 'jscs:vector']);
